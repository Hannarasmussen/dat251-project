...
// boolean favorited = favoriteService.isFavorited(authentication.getName(),
// recipeId);
...
// @PathVariable UUID recipeId,
// Authentication authentication) {
// boolean added = favoriteService.addFavorite(authentication.getName(),
// recipeId);
// return added
...
// @PathVariable UUID recipeId,
// Authentication authentication) {
// boolean removed = favoriteService.removeFavorite(authentication.getName(),
// recipeId);
// return removed
